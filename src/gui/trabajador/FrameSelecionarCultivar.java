 ...
 */
public class FrameSelecionarCultivar extends javax.swing.JFrame
{

    private JLabel lblCultivar;

    public FrameSelecionarCultivar() throws SQLException, Exception
    {
        initComponents();
        this.jtbCultivar = utils.UtilisSql.rellenarJTable("SELECT * FROM TCultivar;", jtbCultivar);
    }

    public FrameSelecionarCultivar(JLabel lblCultivar) throws SQLException, Exception
    {
        initComponents();
        this.jtbCultivar = utils.UtilisSql.rellenarJTable("SELECT * FROM TCultivar;", jtbCultivar);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(FrameSelecionarCultivar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                try
                {
                    new FrameSelecionarCultivar().setVisible(true);
                } catch (Exception ex)
                {
                    Logger.getLogger(FrameSelecionarCultivar.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
